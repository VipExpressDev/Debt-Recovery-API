...
namespace DebtRecoveryPlatform.Models.NonPersistent
{
    public class ContractData
    {
        ...
        public ContractData(string _contractNo, string _clientFullName, string _vipLevel, string _contractStatus, DateTime _dateOfSale, DateTime? _dateDepositDate, string _contactNo, string _emailAddress, string _clientSpouseFullName, string _salesConsultant)
        {
        ...
        public ContractData(string _contractNo, string _clientFullName, string _vipLevel, string _contractStatus)
        {
            ContractNo = _contractNo;
            ClientFullName = _clientFullName;
            VIPLevel = _vipLevel;
        ...
        public static ContractData GetContractData(IConfiguration Configuration, string contractNo)
        {
            ...
            {
                contractData = (new ContractData(contract["ContractNo"].ToString(), contract["ClientFullName"].ToString(), contract["VipLevel"].ToString(), contract["ContractStatus"].ToString(), (DateTime)(contract["DateOfSale"]), contract["DateDepositPaid"] == DBNull.Value ? null : (DateTime?)(contract["DateDepositPaid"]), contract["ContactNo"].ToString(), contract["EmailAddress"].ToString(), contract["ClientSpouseFullName"].ToString(), contract["SalesConsultant"].ToString()));
            }

            return contractData;
        }

        public static List<string> GetPortfolioNumbers(IConfiguration Configuration, string contractNo)
        {
        ...
        public static List<ContractData> GetReferalCount(IConfiguration Configuration, string contractNo)
        {
            ...
            foreach (DataRow contract in dt.Rows)
            {
                referralList.Add(new ContractData(contract["ContractNo"].ToString(), contract["ReferralName"].ToString(), contract["ContractLevel"].ToString(), contract["ContractStatus"].ToString()));
            }
